...
while True: 
    good_breakfast = input ("Does the breakfast look good? y/n ")
    
    if good_breakfast == "y":
        print ("Get some breakfast")
        break
    elif good_breakfast == "n":
        print ("Put a bagel in the toaster")
        while True:
            bagel_toasted = input ("Is the bagel fully toasted? y/n")

            if bagel_toasted == "y":
                print ("Now Add cream cheese!")
                break
            elif bagel_toasted == "n":
                print ("Put it back in")   
            else:
